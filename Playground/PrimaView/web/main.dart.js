...
["_interceptors", "dart:_interceptors", , J, {
  ...
  JSArray: {
    ...
    addAll$1: function(receiver, collection) {
      var t1;
      for (t1 = new H.ListIterator(collection, 0, 0, null); t1.moveNext$0();)
...
["_js_helper", "dart:_js_helper", , H, {
  ...
  }, "call$1", "_matchString$closure", 2, 0, 0],
  _stringIdentity: [function(string) {
    return string;
  }, "call$1", "_stringIdentity$closure", 2, 0, 1],
  ...
  _AllMatchesIterator: {
    ...
    moveNext$0: function() {
      ...
      if (typeof t1 !== "number")
        return H.iae(t1);
      if (t2 <= t1) {
        match = this._regExp._execGlobal$2(this.__js_helper$_string, this._nextIndex);
        if (match != null) {
...
["dart._internal", "dart:_internal", , H, {
  ...
  SubListIterable: {
    ...
    skip$1: function(_, count) {
      return H.SubListIterable$(this._iterable, this._start + count, this._endOrLength, H.getTypeArgumentByIndex(this, 0));
    },
    toList$1$growable: function(_, growable) {
...
["dart.async", "dart:async", , P, {
  ...
  }, "call$1", "_AsyncRun__scheduleImmediateWithSetImmediate$closure", 2, 0, 2],
  ...
  Future_wait_handleError: {
    "^": "Closure:14;box_0,eagerError_1,result_2",
...
["dart.convert", "dart:convert", , P, {
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:26;this_1,codeUnits_2,startIndex_3,endIndex_4",
...
["dart.dom.html", "dart:html", , W, {
  ...
  AnchorElement: {
    "^": "HtmlElement;target=,hash=,host=,pathname=",
    toString$0: function(receiver) {
  ...
  Node: {
    "^": "EventTarget;nodeName=,parent:parentElement=",
    toString$0: function(receiver) {
...
["link_handler", "package:route_hierarchical/click_handler.dart", , V, {
  ...
  DefaultWindowClickHandler: {
    "^": "Object:29;_linkMatcher,_router,_normalizer,_link_handler$_window,_link_handler$_useFragment",
...
["logging", "package:logging/logging.dart", , N, {
  ...
  Level: {
    ...
    $lt: function(_, other) {
      return C.JSInt_methods.$lt(this.value, J.get$value$x(other));
    },
    $gt: function(_, other) {
...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var t1, t2, t3, t4, router;
    L.initNavMenu();
    t1 = P.StreamController_StreamController$broadcast(null, null, true, D.RouteStartEvent);
    t2 = !!!window.history.pushState;
    t3 = window;
    t4 = D.RouteImpl$_new(false, null, null, null, null);
    router = new D.Router(t2, t3, t4, t1, true, false, null);
    router.Router$_init$6$clickHandler$linkMatcher$sortRoutes$useFragment$windowImpl(null, null, null, true, null, null);
    t4.addRoute$4$defaultRoute$enter$name$path(true, F.showLogin$closure(), "login", "/");
    t4.addRoute$3$enter$name$path(F.showFind$closure(), "find", "/find");
    t4.addRoute$3$enter$name$path(F.showResults$closure(), "results", "/results");
    t4.addRoute$3$enter$name$path(F.showView$closure(), "view", "/view");
    router.listen$0();
  }, "call$0", "main$closure", 0, 0, 3],
  showLogin: [function(e) {
    F.hideAll();
    J.set$display$x(document.querySelector("#login").style, "");
  }, "call$1", "showLogin$closure", 2, 0, 12],
  showFind: [function(e) {
    F.hideAll();
    J.set$display$x(document.querySelector("#find").style, "");
  }, "call$1", "showFind$closure", 2, 0, 12],
  showResults: [function(e) {
    F.hideAll();
    J.set$display$x(document.querySelector("#results").style, "");
  }, "call$1", "showResults$closure", 2, 0, 12],
  showView: [function(e) {
    var video;
    F.hideAll();
    J.set$display$x(document.querySelector("#view").style, "");
    video = document.querySelector("#TheVideo");
    J.set$display$x(video.style, "none");
    J.set$autoplay$x(video, true);
    video.controls = true;
    video.src = "https://bodycamstorage.blob.core.windows.net/asset-4b61366c-ea21-47d2-bd95-e1076a46c2b2/20140916104749_Rocky_101.MP4?sv=2012-02-12&sr=c&si=e0e8b205-28fd-4136-b1b4-df1224f396fc&sig=QSRDOIjSZofDHUuil4Pf20OJvYQthnxc6VSAenFevbs%3D&se=2015-02-13T03%3A31%3A52Z";
    J.set$display$x(video.style, "");
  }, "call$1", "showView$closure", 2, 0, 12],
  hideAll: function() {
    J.pause$0$x(document.querySelector("#TheVideo"));
    J.set$display$x(document.querySelector("#login").style, "none");
    J.set$display$x(document.querySelector("#find").style, "none");
    J.set$display$x(document.querySelector("#results").style, "none");
    J.set$display$x(document.querySelector("#view").style, "none");
  }
},
1],
["nav_menu", "package:PrimaView/nav_menu.dart", , L, {
  "^": "",
  initNavMenu: function() {
    var navdrawerContainer, appbarElement, menuBtn, t1, t2;
    navdrawerContainer = document.querySelector(".navdrawer-container");
    appbarElement = document.querySelector(".app-bar");
    menuBtn = document.querySelector(".menu");
    t1 = new L.initNavMenu_closeMenu(navdrawerContainer, appbarElement);
    t2 = J.get$onClick$x(document.querySelector("main"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = J.get$onClick$x(menuBtn);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new L.initNavMenu_toggleMenu(navdrawerContainer, appbarElement)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = J.get$onClick$x(navdrawerContainer);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new L.initNavMenu_closure(t1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
  },
  initNavMenu_closeMenu: {
    "^": "Closure:15;navdrawerContainer_0,appbarElement_1",
    call$1: function(e) {
      var t1 = document.body;
      t1.toString;
      new W._ElementCssClassSet(t1).remove$1(0, "open");
      J.get$classes$x(this.appbarElement_1).remove$1(0, "open");
      J.get$classes$x(this.navdrawerContainer_0).remove$1(0, "open");
    }
  },
  initNavMenu_toggleMenu: {
    "^": "Closure:15;navdrawerContainer_2,appbarElement_3",
    call$1: function(e) {
      var t1, t2;
      t1 = document.body;
      t1.toString;
      new W._ElementCssClassSet(t1).toggle$1("open");
      J.get$classes$x(this.appbarElement_3).toggle$1("open");
      t1 = this.navdrawerContainer_2;
      t2 = J.getInterceptor$x(t1);
      t2.get$classes(t1).toggle$1("open");
      t2.get$classes(t1).add$1(0, "opened");
    }
  },
  initNavMenu_closure: {
    "^": "Closure:15;closeMenu_4",
    call$1: function($event) {
      var t1 = J.getInterceptor$x($event);
      if (J.get$nodeName$x(t1.get$target($event)) === "A" || J.get$nodeName$x(t1.get$target($event)) === "LI")
        this.closeMenu_4.call$1($event);
    }
  }
}],
["route.client", "package:route_hierarchical/client.dart", , D, {
  ...
  RouteImpl: {
    ...
    addRoute$3$enter$name$path: function(enter, name, path) {
      return this.addRoute$10$defaultRoute$dontLeaveOnParamChanges$enter$leave$mount$name$path$preEnter$preLeave$watchQueryParameters(false, false, enter, null, null, name, path, null, null, null);
    },
  ...
  Router: {
    ...
    route$3$forceReload$startingFrom: [function(path, forceReload, startingFrom) {
      var baseRoute, trimmedActivePath, t1, t2, future;
      ...
      if (startingFrom == null) {
        ...
        trimmedActivePath = C.JSArray_methods.sublist$1(t1, H.Lists_indexOf(t2, startingFrom, 0, t2.length) + 1);
    ...
    }, "route$1", "call$3$forceReload$startingFrom", "call$1", "get$route", 2, 5, 30, 6, 31],
    _preLeave$5: function(path, treePath, activePath, baseRoute, forceReload) {
      ...
      for (ll = P.min(activePath.length, treePath.length), t2 = forceReload !== true, i = 0; i < ll; ++i) {
        t3 = J.get$first$ax(t1.mustLeave_0);
      ...
      t2 = J.toList$0$ax(t1.mustLeave_0);
      ...
      return P.Future_wait(preLeaving, false).then$1(new D.Router__preLeave_closure0(t1, this, path, treePath, activePath, baseRoute, forceReload));
    },
    ...
    _preEnter$6: function(path, treePath, activePath, baseRoute, leaveFn, forceReload) {
      ...
      for (ll = P.min(treePath.length, activePath.length), t2 = forceReload !== true, i = 0; i < ll; ++i) {
        t3 = J.get$first$ax(t1.toEnter_0).get$route();
    ...
    _paramsChanged$2: function(route, match) {
      ...
      if (lastEvent != null) {
        t1 = match.urlMatch;
        if (J.$eq(lastEvent.path, t1.get$match()))
    ...
    _parseKeyVal$1: function(kvPair) {
      ...
      return splitPoint === -1 ? [kvPair, ""] : [t1.substring$2(kvPair, 0, splitPoint), C.JSString_methods.substring$1(kvPair, splitPoint + 1)];
    },
    listen$2$appRoot$ignoreClick: function(appRoot, ignoreClick) {
      ...
      if (!ignoreClick) {
        ...
        P._ForwardingStreamSubscription$(t1, this._clickHandler, null, null, false, H.getRuntimeTypeArgument(t1, "_ForwardingStream", 0), H.getRuntimeTypeArgument(t1, "_ForwardingStream", 1));
      }
    },
    listen$0: function() {
    ...
    }, "call$1", "get$_normalizeHash", 2, 0, 1],
  ...
  Router__preLeave_closure0: {
    "^": "Closure:32;box_0,this_2,path_3,treePath_4,activePath_5,baseRoute_6,forceReload_7",
  ...
  Router__enter_closure: {
    ...
    call$1: function(matchedRoute) {
      ...
      t1 = matchedRoute.get$urlMatch().get$match();
      ...
      t3 = this.box_0;
      t3.base_0.set$_currentRoute(t4);
      t3.base_0.get$_currentRoute().set$_lastEvent($event);
  ...
  Router__filterQueryParams_closure: {
    "^": "Closure:15;queryParameters_0,watchQueryParameters_1,result_2",
    call$1: function(key) {
      this.watchQueryParameters_1.any$1(0, new D.Router__filterQueryParams__closure(key));
    }
  },
  Router__filterQueryParams__closure: {
    "^": "Closure:15;key_3",
    call$1: function(pattern) {
      pattern.matchAsPrefix$1(0, this.key_3);
      return true;
    }
  },
  Router__parseQuery_closure: {
    "^": "Closure:17;this_0,params_1",
  ...
  Router_listen__closure: {
    ...
    call$1: function(allowed) {
      if (allowed !== true)
        this.this_5._window.history.back();
    }
  },
  ...
  Router_gotoUrl_closure: {
    ...
    call$1: function(success) {
      ...
      if (success === true) {
        ...
        t2 = this.url_1;
        if (t1._useFragment)
          t1._window.location.assign("#" + H.S(t2));
        else {
          title = H.interceptedTypeCast(t1._window.document, "$isHtmlDocument").title;
          t1._window.history.pushState(null, title, t2);
        }
      }
    }
  },
...
["route.utils", "package:route_hierarchical/src/utils.dart", , U, {
  ...
  mapsShallowEqual_closure: {
    ...
    call$1: function(k) {
      var t1 = this.b_1;
      return t1.containsKey$1(k) === true && J.$eq(this.a_0.$index(0, k), t1.$index(0, k));
    }
  }
}],
...
["url_template", "package:route_hierarchical/url_template.dart", , S, {
  ...
  UrlTemplate: {
    ...
    compareTo$1: function(_, other) {
      ...
      if (!!J.getInterceptor(other).$isUrlTemplate) {
        ...
        otherPatternParts = J.getInterceptor$s(otherPattern).split$1(otherPattern, "/");
    ...
    _compileTemplate$1: function(template) {
      ...
      t1.template_0 = C.JSString_methods.replaceAllMapped$2(template, $.get$_specialChars(), new S.UrlTemplate__compileTemplate_closure());
  ...
  UrlTemplate__compileTemplate_closure0: {
    "^": "Closure:38;box_0,this_1,sb_2",
    call$1: function(m) {
      var t1, paramName, t2, txt;
  ...
  UrlTemplate__compileTemplate__closure: {
    "^": "Closure:39;paramName_3",
    call$1: function(params) {
      return params.$index(0, this.paramName_3);
    }
  }
}],
]);
...
;(function() {
  ...
  _.$isRouteEvent = TRUE;
  _.$isObject = TRUE;
  _ = D.RoutePreEnterEvent;
  _.$isRouteEvent = TRUE;
  _.$isObject = TRUE;
  _ = D.RoutePreLeaveEvent;
  _.$isRouteEvent = TRUE;
  _.$isObject = TRUE;
  _ = D.RouteLeaveEvent;
  _.$isRouteEvent = TRUE;
...
init.metadata = [{func: "String__Match", ret: P.String, args: [P.Match]},
