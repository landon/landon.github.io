...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "CanvasGradient|CanvasPattern|CanvasRenderingContext|CanvasRenderingContext2D|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList"
  },
  JSBool: {
    "^": "bool/Interceptor;",
    toString$0: function(receiver) {
...
["dart.async", "dart:async", , P, {
  ...
  _Future__propagateToListeners_handleWhenCompleteCallback_closure: {
    "^": "Closure:8;box_2,listener_11",
    call$1: function(ignored) {
      P._Future__propagateToListeners(this.box_2.source_4, this.listener_11);
    }
  },
  _Future__propagateToListeners_handleWhenCompleteCallback_closure0: {
    "^": "Closure:12;box_0,listener_12",
    call$2: function(error, stackTrace) {
...
["sunflower", "sunflower.dart", , B, {
  "^": "",
  main: [function() {
    var t1 = J.get$onChange$x($.get$slider());
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.main_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    B.draw();
  }, "call$0", "main$closure", 0, 0, 1],
  draw: function() {
    var t1, i, t2, theta, r, t3;
    $.seeds = H.Primitives_parseInt(J.get$value$x($.get$slider()), null, null);
    t1 = $.get$context();
    t1.clearRect(0, 0, 300, 300);
    i = 0;
    while (true) {
      t2 = $.seeds;
      if (typeof t2 !== "number")
      ...
      t1.arc(150 + r * t2, 150 - r * t3, 2, 0, 6.283185307179586, false);
      t1.fill();
      t1.closePath();
      t1.stroke();
      ++i;
    }
    $.get$notes().textContent = H.S(t2) + " seeds";
  },
  main_closure: {
    "^": "Closure:8;",
    call$1: function(e) {
...
Isolate.$lazy($, "notes", "notes", "get$notes", function() {
  return document.querySelector("#notes");
});
Isolate.$lazy($, "PHI", "PHI", "get$PHI", function() {
