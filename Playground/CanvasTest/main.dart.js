...
["", "VideoPile.dart", , V, {
  "^": "",
  VideoPile: {
    "^": "Object;_timeUpdatedController,_videos,_durations,_canvasContext,_currentIndex,_redrawTimer",
    beginPlayback$0: function() {
      var t1, t2;
      t1 = this._videos;
      t2 = this._currentIndex;
      if (t2 >>> 0 !== t2 || t2 >= t1.length)
        return H.ioore(t1, t2);
      J.play$0$x(t1[t2]);
      this._redrawTimer = P.Timer_Timer$periodic(C.Duration_20000, new V.VideoPile_beginPlayback_closure(this));
    },
    seek$1: function(time) {
      var t1, j, prior, t2, t3;
      this.pause$1(0, true);
      t1 = this._durations;
      t1.length;
      j = 0;
      ...
      if (j !== t1)
        this._changeVideoIndex$2(j, t2.$sub(time, prior));
      else {
        t3 = this._videos;
        if (t1 >>> 0 !== t1 || t1 >= t3.length)
          return H.ioore(t3, t1);
        J.set$currentTime$x(t3[t1], t2.$sub(time, prior));
      }
    },
    pause$1: function(_, shouldPause) {
      var t1, t2;
      if (shouldPause) {
        t1 = this._videos;
        t2 = this._currentIndex;
    ...
    _createVideoElement$1: [function(url) {
      var ve, t1, t2;
      ve = document.createElement("video", null);
      t1 = J.getInterceptor$x(ve);
      t2 = t1.get$onEnded(ve);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(this.get$_onEnded()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      ve.setAttribute("type", "video/mp4");
      t1.set$src(ve, url);
      t1.load$0(ve);
      return ve;
    }, "call$1", "get$_createVideoElement", 2, 0, 11],
    _onEnded$1: [function(e) {
      var t1 = this._currentIndex;
      if (typeof t1 !== "number")
        return t1.$add();
      this._changeVideoIndex$2(C.JSInt_methods.$mod(t1 + 1, this._videos.length), 0);
    }, "call$1", "get$_onEnded", 2, 0, 12],
    _changeVideoIndex$2: function(index, offset) {
      var previousIndex, t1, t2;
      previousIndex = this._currentIndex;
      this._currentIndex = index;
      t1 = this._videos;
      if (previousIndex >>> 0 !== previousIndex || previousIndex >= t1.length)
        return H.ioore(t1, previousIndex);
      J.set$muted$x(t1[previousIndex], true);
      t1 = this._videos;
      t2 = this._currentIndex;
      if (t2 >>> 0 !== t2 || t2 >= t1.length)
        return H.ioore(t1, t2);
      J.set$muted$x(t1[t2], false);
      t2 = this._videos;
      t1 = this._currentIndex;
      if (t1 >>> 0 !== t1 || t1 >= t2.length)
        return H.ioore(t2, t1);
      J.set$currentTime$x(t2[t1], offset);
      t1 = this._videos;
      t2 = this._currentIndex;
      if (t2 >>> 0 !== t2 || t2 >= t1.length)
        return H.ioore(t1, t2);
      J.play$0$x(t1[t2]);
      t2 = this._videos;
      if (previousIndex >= t2.length)
        return H.ioore(t2, previousIndex);
      J.pause$0$x(t2[previousIndex]);
      t2 = this._videos;
      if (previousIndex >= t2.length)
        return H.ioore(t2, previousIndex);
      J.set$currentTime$x(t2[previousIndex], 0);
    },
    _drawFrame$0: function() {
      var i, t1, ve, t2, priorTime, j;
      ...
      t2 = t1.canvas;
      t1.drawImage(ve, 0, 0, t2.width, t2.height);
      for (t1 = this._durations, priorTime = 0, j = 0; j < i; ++j) {
        t1.length;
        if (j >= 7)
          return H.ioore(t1, j);
        priorTime += t1[j];
      }
      t1 = this._timeUpdatedController;
      t2 = J.get$currentTime$x(ve);
      if (typeof t2 !== "number")
        return H.iae(t2);
      if (t1._state >= 4)
        H.throwExpression(t1._addEventError$0());
      t1._sendData$1(priorTime + t2);
    },
    VideoPile$3: function(targetCanvas, videoUrls, durations) {
      this._canvasContext = J.get$context2D$x(targetCanvas);
      this._videos = H.setRuntimeTypeInfo(new H.MappedListIterable(videoUrls, this.get$_createVideoElement()), [null, null]).toList$0(0);
      this._durations = durations;
      this._currentIndex = 0;
    },
    static: {"^": "VideoPile__redrawDuration"}
  },
  VideoPile_beginPlayback_closure: {
    "^": "Closure:13;this_0",
    call$1: function(_) {
      return this.this_0._drawFrame$0();
    }
  }
}],
...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|Blob|CanvasRenderingContext2D|DOMError|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["dart.dom.html", "dart:html", , W, {
  ...
  Element: {
    ...
    get$onEnded: function(receiver) {
      return H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(receiver, "ended", false), [null]);
    },
  ...
  InputElement: {
    "^": "HtmlElement;src},step},type},value%",
    "%": "HTMLInputElement"
  },
  LIElement: {
    "^": "HtmlElement;value%",
  ...
  MediaElement: {
    "^": "HtmlElement;currentTime%,error=,muted},paused=,src}",
...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var durations, t1, button, theCanvas, t2;
    durations = [4.171, 2.997, 4.72, 5.558, 3.592, 3.833, 5.596];
    t1 = W.InputElement_InputElement("range");
    J.set$step$x(t1, "0.01");
    t1.min = C.JSInt_methods.toString$0(0);
    t1.max = J.toString$0(H.IterableMixinWorkaround_fold(durations, 0, new F.main_closure()));
    J.set$width$x(t1.style, "75%");
    t1.value = "0";
    $.slider = t1;
    t1 = C.InputElement_methods.get$onMouseDown(t1);
    ...
    t1 = J.get$onMouseUp$x($.slider);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.main_closure1()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = $.slider;
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, "touchstart", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.main_closure2()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = $.slider;
    t1.toString;
    ...
    t1 = document.body;
    t1.toString;
    t1.appendChild(document.createElement("br", null));
...
{func: "VideoElement__String", ret: W.VideoElement, args: [P.String]},
